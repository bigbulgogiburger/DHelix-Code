...
export default function HookLoaderPage() {
        ...
        <RevealOnScroll>
          <div style={{ marginBottom: "48px" }}>
            ...
            <h1 className="text-3xl font-bold tracking-tight leading-[1.15] mb-3">
              <span className="text-gray-900">Hook Loader</span>
            </h1>
            <p className="text-[16px] text-gray-600 max-w-[640px]">
              settings.json에서 훅 설정을 읽고{" "}
              <span className="text-violet-600 font-semibold">Zod 스키마</span>로 검증하는
              모듈입니다.
              <span className="text-cyan-600 font-semibold"> discriminatedUnion</span>으로 핸들러
              타입별 필수 필드를 엄격하게 확인합니다.
            </p>
          </div>
        </RevealOnScroll>
        ...
        <RevealOnScroll>
          <section style={{ marginBottom: "64px" }}>
            ...
            <p className="text-[14px] text-gray-600 leading-relaxed mb-4">
              ...
              적용합니다. 파일이 없거나 <code className="text-cyan-600 text-xs">"hooks"</code> 키가
              없으면 빈 설정을 반환합니다.
            </p>

            <Callout type="tip" icon="💡">
              <strong>타입 안전성:</strong>{" "}
              <code className="text-cyan-600 text-xs">type: "command"</code>이면{" "}
              <code className="text-cyan-600 text-xs">command</code> 필드 필수,
              <code className="text-cyan-600 text-xs"> type: "http"</code>이면{" "}
              <code className="text-cyan-600 text-xs">url</code> 필드 필수 &mdash; 잘못된 조합은
              Zod가 파싱 단계에서 거부합니다.
            </Callout>
  ...
  style ERROR2 fill:#f1f5f9,stroke:#ef4444,color:#1e293b`}
        ...
        <RevealOnScroll>
          <section style={{ marginBottom: "64px" }}>
            ...
            <div className="mb-8">
              ...
              <div className="mt-3">
                <h4 className="text-[13px] font-bold text-gray-900 mb-2">
                  반환: <code className="text-violet-600 text-xs">Promise&lt;HookConfig&gt;</code>
                </h4>
                <p className="text-[13px] text-gray-600">
                  이벤트 이름을 키로, 규칙 배열을 값으로 가진 객체. 예:{" "}
                  <code className="text-cyan-600 text-xs">
                    {'{ PostToolUse: [{ matcher: "file_edit", hooks: [...] }] }'}
                  </code>
                </p>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="text-[13px] text-gray-600 mb-3">
                원시 객체를 파싱하고 검증하여 타입 안전한 HookConfig를 반환합니다. 이벤트 이름 검증
                + Zod 스키마 검증의 2단계를 수행합니다.
              </p>
              <ParamTable
                params={[
                  {
                    ...
                    type: "unknown",
                    required: true,
                    desc: "JSON 파싱 결과 (null/undefined 허용 → 빈 설정 반환)",
                  },
                ]}
              />
              <div className="mt-3">
                <h4 className="text-[13px] font-bold text-gray-900 mb-2">
                  반환: <code className="text-violet-600 text-xs">HookConfig</code>
                </h4>
              </div>
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-4">
                <div className="flex flex-col gap-2.5 text-[13px] text-gray-600">
                  <div className="flex gap-3">
                    ...
                    <span>
                      discriminatedUnion("type") &mdash; command / http / prompt / agent 4가지
                    </span>
                  </div>
                  <div className="flex gap-3">
              ...
              <Callout type="warn" icon="⚠️">
                ...
                <code className="text-cyan-600 text-xs"> HOOK_EVENTS</code> 목록에 없는 이벤트
                이름은
          ...
          <section style={{ marginBottom: "64px" }}>
            ...
            <CodeBlock>
              ...
              <span className="text-[#8b949e]">
                {"// config.PostToolUse → 규칙 배열 또는 undefined"}
              </span>
            </CodeBlock>
                ...
                <table className="w-full border-collapse text-[12px]">
                  ...
                  <tbody className="text-gray-600">
                    ...
                    <tr className="border-b border-gray-200">
                      ...
                      <td className="p-2.5">
                        <code className="text-cyan-600">url</code> (유효한 URL)
                      </td>
                    ...
                    <tr className="border-b border-gray-200">
                      ...
                      <td className="p-2.5">
                        <code className="text-cyan-600">prompt</code>,{" "}
                        <code className="text-cyan-600">promptMessage</code>
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="p-2.5">
                        <code className="text-cyan-600">prompt</code>,{" "}
                        <code className="text-cyan-600">validator</code>,{" "}
                        <code className="text-cyan-600">description</code>
                      </td>
        ...
        <RevealOnScroll>
          <section style={{ marginBottom: "64px" }}>
            ...
            <p className="text-[13px] text-gray-600 mb-3">
              설정 검증은 두 단계로 분리되어 있습니다. 이벤트 이름은 Zod로는 열거할 수 없는 동적
              키이므로 별도의 <code className="text-cyan-600 text-xs">validateEventNames()</code>로
              먼저 확인합니다.
            </p>
  ...
  style CONFIG fill:#f8fafc,stroke:#10b981,color:#10b981,stroke-width:2px`}
            ...
            <p className="text-[13px] text-gray-600 mb-3">
              <code className="text-cyan-600 text-xs">loadHookConfig()</code>은 3가지 경우를
              구분합니다:
            </p>
            <div className="bg-white border border-gray-200 rounded-xl p-4">
              <div className="flex flex-col gap-2.5 text-[13px] text-gray-600">
            ...
            <Callout type="info" icon="📝">
              <strong>null/undefined 허용:</strong>{" "}
              <code className="text-cyan-600 text-xs">parseHookConfig(null)</code>이나
              <code className="text-cyan-600 text-xs"> parseHookConfig(undefined)</code>는 에러 없이
              빈 설정을 반환합니다. settings.json에{" "}
              <code className="text-cyan-600 text-xs">"hooks"</code> 키가 아예 없는 경우를 우아하게
              처리합니다.
            </Callout>
          </section>
        </RevealOnScroll>
        ...
        <RevealOnScroll>
          <section style={{ marginBottom: "64px" }}>
            ...
            <div className="flex flex-col gap-4">
              <div className="bg-white border border-gray-200 rounded-xl p-5">
                ...
                <div className="text-[13px] text-gray-600 leading-relaxed">
                  <p>
                    ...
                    <code className="text-cyan-600 text-xs">HOOK_EVENTS</code> 목록에 정의되어
                    있습니다. 예: <code className="text-cyan-600 text-xs">"PostToolUse"</code>,{" "}
                    <code className="text-cyan-600 text-xs">"PreToolUse"</code>. 대소문자에
                    주의하세요.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-5">
                <h4 className="text-[14px] font-bold mb-2 flex items-center gap-2">
                  <span className="text-red-600">Q.</span> Zod 파싱 에러: Required at
                  "hooks[0].command"
                </h4>
                <div className="text-[13px] text-gray-600 leading-relaxed">
                  <p>
                    ...
                    discriminatedUnion은 <code className="text-cyan-600 text-xs">type</code> 값에
                    따라 필수 필드를 결정합니다.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-5">
                ...
                <div className="text-[13px] text-gray-600 leading-relaxed">
                  <p className="mb-2">
                    <strong className="text-gray-900">원인 1:</strong> settings.json의 JSON 문법
                    오류. 파싱 실패 시 ENOENT가 아닌 다른 에러가 발생하여 HookLoadError로
                    래핑됩니다.
                  </p>
                  <p>
                    <strong className="text-gray-900">원인 2:</strong>{" "}
                    <code className="text-cyan-600 text-xs">"hooks"</code>가 아닌 다른 키 이름을
                    사용했습니다. 정확히 <code className="text-cyan-600 text-xs">"hooks"</code>여야
                    합니다.
                  </p>
                </div>
              </div>
