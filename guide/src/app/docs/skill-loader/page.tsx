...
export default function SkillLoaderPage() {
        ...
        <RevealOnScroll>
          <div style={{ marginBottom: "48px" }}>
            ...
            <h1 className="text-3xl font-bold tracking-tight leading-[1.15] mb-3">
              <span className="text-gray-900">Skill Loader</span>
            </h1>
            <p className="text-[16px] text-gray-600 max-w-[640px]">
              디렉토리에서 스킬 파일(.md)을 탐색하고 로딩하는 모듈입니다. 프론트매터(YAML
              메타데이터)를 파싱하고 <span className="text-cyan-600 font-semibold">Zod 스키마</span>
              로 검증하여
              <span className="text-violet-600 font-semibold"> SkillDefinition</span> 객체를
              생성합니다.
            </p>
          </div>
        </RevealOnScroll>
        ...
        <RevealOnScroll>
          <section style={{ marginBottom: "64px" }}>
            ...
            <p className="text-[14px] text-gray-600 leading-relaxed mb-4">
              스킬은 <strong className="text-gray-900">마크다운 파일</strong>로 작성된 재사용 가능한
              프롬프트 템플릿입니다. Skill Loader는 디렉토리를 순회하며{" "}
              <code className="text-cyan-600 text-xs">.md</code> 파일을 찾고, 각 파일의{" "}
              <span className="text-violet-600 font-semibold">프론트매터</span>를 파싱한 뒤
              <span className="text-cyan-600 font-semibold"> Zod 스키마</span>로 검증합니다. 개별
              파일 로딩 실패는 해당 스킬만 건너뛰고 나머지를 계속 로딩하는{" "}
              <strong className="text-gray-900">비치명적 오류</strong> 전략을 사용합니다.
            </p>
  ...
  style DEF fill:#f8fafc,stroke:#06b6d4,color:#06b6d4,stroke-width:2px`}
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5 mt-4">
              ...
              <div className="flex flex-col gap-2.5 text-[13px] text-gray-600">
                <div className="flex gap-3">
                  ...
                  <span>
                    <code className="text-cyan-600 text-xs">---</code> 사이의 YAML 메타데이터 (name,
                    description, context 등)
                  </span>
                </div>
                <div className="flex gap-3">
                ...
                <div className="flex gap-3">
                  ...
                  <span>
                    ...
                    <code className="text-cyan-600 text-xs">{"`!command`"}</code> 등 실행 시 치환
                  </span>
                </div>
              </div>
            </div>
          ...
          <section style={{ marginBottom: "64px" }}>
            ...
            <div className="mb-8">
              ...
              <p className="text-[13px] text-gray-600 mb-3">
                ...
                <code className="text-red-600 text-xs">SKILL_LOAD_ERROR</code>입니다.
              </p>
            ...
            <div className="mb-8">
              ...
              <p className="text-[13px] text-gray-600 mb-3">
                단일 마크다운 파일에서 스킬을 로드합니다. 파일을 읽고, 프론트매터와 본문을 분리한
                후, 프론트매터를 <code className="text-cyan-600 text-xs">Zod 스키마</code>로
                검증하여
              ...
              <div className="mt-3">
                <h4 className="text-[13px] font-bold text-gray-900 mb-2">
                  반환 타입:{" "}
                  <code className="text-violet-600 text-xs">{"Promise<SkillDefinition>"}</code>
                </h4>
                <ParamTable
                  params={[
                    {
              ...
              <Callout type="warn" icon="⚠️">
                프론트매터가 없거나 Zod 검증에 실패하면{" "}
                <code className="text-red-600 text-xs">SkillLoadError</code>를 던집니다.
                프론트매터의 <code className="text-cyan-600 text-xs">name</code>과{" "}
                <code className="text-cyan-600 text-xs">description</code>은 필수 필드입니다.
              </Callout>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="text-[13px] text-gray-600 mb-3">
                디렉토리의 모든 <code className="text-cyan-600 text-xs">.md</code> 파일에서 스킬을
                로드합니다. 개별 파일 로딩 실패는 해당 스킬만 건너뛰고 계속 진행합니다.
              </p>
            ...
            <div className="mb-8">
              ...
              <p className="text-[13px] text-gray-600 mb-3">
                YAML 유사 프론트매터를 파싱하여 키-값 객체로 변환합니다. kebab-case 키는 자동으로
                camelCase로 변환됩니다.
              </p>
            ...
            <div className="mb-4">
              ...
              <p className="text-[13px] text-gray-600 mb-3">
                스킬 파일을 프론트매터와 본문으로 분리합니다. 첫 줄이{" "}
                <code className="text-cyan-600 text-xs">---</code>가 아니면 프론트매터 없음으로
                판단하고 전체 내용을 본문으로 취급합니다.
              </p>
              <ParamTable
                params={[
                  {
        ...
        <RevealOnScroll>
          <section style={{ marginBottom: "64px" }}>
            ...
            <p className="text-[13px] text-gray-600 mb-3">
              특정 <code className="text-cyan-600 text-xs">.md</code> 파일에서 하나의 스킬을
              로드합니다. 프론트매터가 유효해야 하며, 검증 실패 시 에러를 던집니다.
            </p>
            ...
            <p className="text-[13px] text-gray-600 mb-3">
              디렉토리 내 모든 <code className="text-cyan-600 text-xs">.md</code> 파일을 순회하며
              스킬을 일괄 로드합니다. 개별 파일 실패는 무시되고 성공한 것만 반환됩니다.
            </p>
            ...
            <CodeBlock>
              ...
              {"\n"}
              <span className="text-[#8b949e]">
                {"// 유효한 스킬만 포함, 실패한 파일은 자동 건너뜀"}
              </span>
            </CodeBlock>

            <DeepDive title="스킬 파일 작성 예시">
              <p className="mb-3">
                스킬 파일은 프론트매터와 본문으로 구성됩니다. 프론트매터에서 스킬의 메타데이터를
                정의하고, 본문에 LLM에 전달할 프롬프트 템플릿을 작성합니다.
              </p>
              ...
              <Callout type="warn" icon="⚠️">
                <code className="text-cyan-600 text-xs">allowed-tools</code>는 kebab-case로
                작성하세요. 로더가 자동으로{" "}
                <code className="text-cyan-600 text-xs">allowedTools</code>(camelCase)로 변환합니다.
              </Callout>
            </DeepDive>
          </section>
        </RevealOnScroll>
        ...
        <RevealOnScroll>
          <section style={{ marginBottom: "64px" }}>
            ...
            <p className="text-[13px] text-gray-600 mb-3">
              <code className="text-cyan-600 text-xs">splitFrontmatterAndBody()</code>는 파일 첫
              줄이 <code className="text-cyan-600 text-xs">---</code>인지 확인하고, 두 번째{" "}
              <code className="text-cyan-600 text-xs">---</code>까지를 프론트매터로 분리합니다.
            </p>
  ...
  style RETURN fill:#f8fafc,stroke:#10b981,color:#10b981,stroke-width:2px`}
            ...
            <p className="text-[13px] text-gray-600 mb-3">
              <code className="text-cyan-600 text-xs">loadSkillsFromDirectory()</code>는 두 가지
              에러 수준을 구분합니다.
            </p>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5">
              <div className="flex flex-col gap-2.5 text-[13px] text-gray-600">
                <div className="flex gap-3">
                  ...
                  <span>
                    개별 스킬 파일 로딩 실패 &mdash; 해당 스킬만 건너뛰고 나머지 계속 로딩
                  </span>
                </div>
                <div className="flex gap-3">
                ...
                <div className="flex gap-3">
                  ...
                  <span>
                    디렉토리 읽기 자체 실패(ENOENT 외) &mdash;{" "}
                    <code className="text-red-600 text-xs">SkillLoadError</code> throw
                  </span>
                </div>
              </div>
            </div>
            ...
            <Callout type="info" icon="📝">
              <strong>SkillLoadError</strong>는{" "}
              <code className="text-cyan-600 text-xs">BaseError</code>를 상속하며, 에러 코드{" "}
              <code className="text-cyan-600 text-xs">SKILL_LOAD_ERROR</code>와 함께 파일 경로, 원인
              정보를 context로 전달합니다.
            </Callout>
          </section>
        </RevealOnScroll>
            ...
            <div className="flex flex-col gap-4">
              <div className="bg-white border border-gray-200 rounded-xl p-5">
                <h4 className="text-[14px] font-bold mb-2 flex items-center gap-2">
                  <span className="text-red-600">Q.</span> 스킬 파일을 만들었는데 /명령어로 나타나지
                  않아요
                </h4>
                <div className="text-[13px] text-gray-600 leading-relaxed">
                  <p className="mb-2">
                    <strong className="text-gray-900">원인 1:</strong> 프론트매터가 없거나 형식이
                    잘못되었습니다. 파일 첫 줄이 <code className="text-cyan-600 text-xs">---</code>
                    로 시작하는지, 닫는 <code className="text-cyan-600 text-xs">---</code>가 있는지
                    확인하세요.
                  </p>
                  <p className="mb-2">
                    <strong className="text-gray-900">원인 2:</strong>{" "}
                    <code className="text-cyan-600 text-xs">name</code>과{" "}
                    <code className="text-cyan-600 text-xs">description</code>이 비어있습니다. 두
                    필드는 필수이며, 빈 문자열이면 Zod 검증에 실패합니다.
                  </p>
                  <p>
                    <strong className="text-gray-900">원인 3:</strong> 파일 확장자가{" "}
                    <code className="text-cyan-600 text-xs">.md</code>가 아닙니다. 로더는{" "}
                    <code className="text-cyan-600 text-xs">.md</code> 확장자만 필터링합니다.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-5">
                ...
                <div className="text-[13px] text-gray-600 leading-relaxed">
                  <p>
                    프론트매터에서{" "}
                    <code className="text-cyan-600 text-xs">allowed-tools: [Bash, Read]</code>처럼
                    kebab-case로 작성했는지 확인하세요. 로더가 자동으로 camelCase(
                    <code className="text-cyan-600 text-xs">allowedTools</code>)로 변환합니다. YAML
                    인라인 배열 문법(<code className="text-cyan-600 text-xs">[item1, item2]</code>
                    )을 사용해야 합니다.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-5">
                ...
                <div className="text-[13px] text-gray-600 leading-relaxed">
                  <p>
                    <code className="text-cyan-600 text-xs">loadSkillsFromDirectory()</code>는
                    디렉토리가 없으면 에러 없이 빈 배열을 반환합니다. 에러가 발생한다면 권한 문제 등{" "}
                    <code className="text-cyan-600 text-xs">ENOENT</code> 외의 파일시스템
                    에러입니다. 디렉토리 경로와 권한을 확인하세요.
                  </p>
                </div>
              </div>
            </div>
