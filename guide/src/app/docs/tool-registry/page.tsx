...
export default function ToolRegistryPage() {
  return (
      ...
      <div className="max-w-[900px] mx-auto px-4 sm:px-8">
        ...
        <RevealOnScroll>
          <section className="mb-16">
            ...
            <div className="text-[14px] text-text-secondary leading-relaxed space-y-4 mb-8">
              <p>
                <strong className="text-text-primary">ToolRegistry</strong>는 dbcode의 모든 도구(내장 16개 + MCP 외부 도구)를
                하나의 <code className="text-accent-cyan text-[13px]">Map&lt;string, ToolDefinition&gt;</code>에 저장하고 관리하는 싱글턴 클래스입니다.
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4">
                <div className="bg-bg-card border border-border rounded-xl p-4 border-l-[3px] border-l-accent-green">
                  <div className="text-sm font-bold text-accent-green mb-1">🔥 Hot Tools</div>
                ...
                <div className="bg-bg-card border border-border rounded-xl p-4 border-l-[3px] border-l-accent-purple">
                  <div className="text-sm font-bold text-accent-purple mb-1">💤 Deferred Tools</div>
                  <p className="text-[13px] text-text-secondary">
    ...
    subgraph Registry["🗄️ ToolRegistry"]
        ...
        HOT["Hot Tools Set (6개)"]
        SEARCH["MCPToolSearch?"]
    end

    subgraph Input["도구 등록"]
        BUILTIN["Built-in Tools (16개)"]
        MCP["MCP Tools (외부)"]
    end
    ...
    style Registry fill:#1a2a1a,stroke:#10b981,stroke-width:2px
    style HOT fill:#2a1a1a,stroke:#ef4444,stroke-width:1px
    style SEARCH fill:#1a1a2a,stroke:#8b5cf6,stroke-width:1px`}
            />
        ...
        <RevealOnScroll>
          <section className="mb-16">
            ...
            <p className="text-[13px] text-text-secondary mb-3">
              모든 도구가 구현해야 하는 핵심 인터페이스입니다. 제네릭 <code className="text-accent-purple">TParams</code>는
...
{pc("}")}
            ...
            <div className="bg-bg-card border border-border rounded-xl p-5 mb-3">
              <div className="flex items-center gap-2 mb-2">
                <code className="text-[13px] font-bold text-accent-cyan">register(tool)</code>
                <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-[rgba(16,185,129,0.1)] text-accent-green">write</span>
              </div>
              <p className="text-[13px] text-text-secondary">
                도구를 레지스트리에 등록합니다. 이미 같은 이름으로 등록된 도구가 있으면 <code className="text-accent-red">ToolError</code>를 던져 중복 등록을 방지합니다.
              </p>
            </div>
            ...
            <div className="bg-bg-card border border-border rounded-xl p-5 mb-3">
              <div className="flex items-center gap-2 mb-2">
                <code className="text-[13px] font-bold text-accent-cyan">registerAll(tools)</code>
                <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-[rgba(16,185,129,0.1)] text-accent-green">write</span>
              </div>
              <p className="text-[13px] text-text-secondary">
                여러 도구를 한 번에 등록합니다. 초기화 시 16개 내장 도구를 일괄 등록할 때 사용합니다.
                내부적으로 <code className="text-accent-cyan">register()</code>를 반복 호출합니다.
              </p>
            </div>
            ...
            <div className="bg-bg-card border border-border rounded-xl p-5 mb-3">
              <div className="flex items-center gap-2 mb-2">
                <code className="text-[13px] font-bold text-accent-cyan">get(name)</code>
                <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-[rgba(59,130,246,0.1)] text-accent-blue">read</span>
              </div>
              <p className="text-[13px] text-text-secondary">
                이름으로 도구를 조회합니다. 없으면 <code className="text-accent-purple">undefined</code>를 반환합니다.
            ...
            <div className="bg-bg-card border border-border rounded-xl p-5 mb-3">
              <div className="flex items-center gap-2 mb-2">
                <code className="text-[13px] font-bold text-accent-cyan">require(name)</code>
                <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-[rgba(59,130,246,0.1)] text-accent-blue">read</span>
                <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-[rgba(239,68,68,0.1)] text-accent-red">throws</span>
              </div>
              <p className="text-[13px] text-text-secondary">
                이름으로 도구를 조회하되, 없으면 <code className="text-accent-red">ToolError</code>를 던집니다.
                반드시 존재해야 하는 내장 도구를 조회할 때 사용합니다. <code className="text-accent-cyan">get()</code>의 안전 버전입니다.
              </p>
            </div>
            ...
            <div className="bg-bg-card border border-border rounded-xl p-5 mb-3">
              <div className="flex items-center gap-2 mb-2">
                <code className="text-[13px] font-bold text-accent-cyan">has(name)</code>
                <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-[rgba(59,130,246,0.1)] text-accent-blue">read</span>
              </div>
              <p className="text-[13px] text-text-secondary">
                특정 이름의 도구가 등록되어 있는지 <code className="text-accent-purple">boolean</code>으로 반환합니다.
            ...
            <div className="bg-bg-card border border-border rounded-xl p-5 mb-3">
              <div className="flex items-center gap-2 mb-2">
                <code className="text-[13px] font-bold text-accent-cyan">getAll()</code>
                <span className="mx-1 text-text-muted">/</span>
                <code className="text-[13px] font-bold text-accent-cyan">getNames()</code>
                <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-[rgba(59,130,246,0.1)] text-accent-blue">read</span>
              </div>
              <p className="text-[13px] text-text-secondary">
                등록된 모든 도구 정의 배열 또는 이름 배열을 <code className="text-accent-purple">readonly</code>로 반환합니다.
            ...
            <div className="bg-bg-card border border-border rounded-xl p-5 mb-3">
              <div className="flex items-center gap-2 mb-2">
                <code className="text-[13px] font-bold text-accent-cyan">getDefinitionsForLLM()</code>
                <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-[rgba(139,92,246,0.1)] text-accent-purple">transform</span>
              </div>
              <p className="text-[13px] text-text-secondary">
                <strong>모든</strong> 도구를 OpenAI Function Calling 형식으로 변환합니다.
                Zod 스키마 → JSON Schema 변환은 <code className="text-accent-cyan">zodSchemaToJsonSchema()</code>에 위임합니다.
            ...
            <div className="bg-bg-card border border-border rounded-xl p-5 mb-3">
              <div className="flex items-center gap-2 mb-2">
                <code className="text-[13px] font-bold text-accent-cyan">getHotDefinitionsForLLM()</code>
                <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-[rgba(139,92,246,0.1)] text-accent-purple">transform</span>
                <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-[rgba(245,158,11,0.1)] text-accent-orange">핵심</span>
              </div>
              <p className="text-[13px] text-text-secondary">
                Hot Tools + 내장 도구(non-MCP)만 LLM 형식으로 반환합니다.
                <code className="text-accent-cyan">mcp__</code> 접두사 도구를 필터링하여 MCP 도구의 전체 스키마 전달을 방지합니다.
            ...
            <div className="bg-bg-card border border-border rounded-xl p-5 mb-3">
              <div className="flex items-center gap-2 mb-2">
                <code className="text-[13px] font-bold text-accent-cyan">setToolSearch(search)</code>
                <span className="mx-1 text-text-muted">/</span>
                <code className="text-[13px] font-bold text-accent-cyan">isDeferredMode</code>
                <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-[rgba(16,185,129,0.1)] text-accent-green">config</span>
              </div>
              <p className="text-[13px] text-text-secondary">
                <code className="text-accent-cyan">MCPToolSearch</code> 인스턴스를 연결하여 Deferred Loading을 활성화합니다.
                <code className="text-accent-cyan">isDeferredMode</code> getter는 toolSearch가 연결되어 있고
                지연 로딩할 도구가 1개 이상일 때 <code className="text-accent-purple">true</code>를 반환합니다.
              </p>
            </div>
            ...
            <div className="bg-bg-card border border-border rounded-xl p-5 mb-3">
              <div className="flex items-center gap-2 mb-2">
                <code className="text-[13px] font-bold text-accent-cyan">getDeferredToolsSummary()</code>
                <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-[rgba(139,92,246,0.1)] text-accent-purple">transform</span>
              </div>
              <p className="text-[13px] text-text-secondary">
            ...
            <div className="bg-bg-card border border-border rounded-xl p-5 mb-3">
              <div className="flex items-center gap-2 mb-2">
                <code className="text-[13px] font-bold text-accent-cyan">resolveDeferredTool(namespacedName)</code>
                <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-[rgba(59,130,246,0.1)] text-accent-blue">read</span>
              </div>
              <p className="text-[13px] text-text-secondary">
                네임스페이스 이름(예: <code className="text-accent-orange">&quot;mcp__github__create_issue&quot;</code>)으로
            ...
            <div className="bg-bg-card border border-border rounded-xl p-5 mb-3">
              <div className="flex items-center gap-2 mb-2">
                <code className="text-[13px] font-bold text-accent-cyan">searchDeferredTools(query, maxResults?)</code>
                <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-[rgba(59,130,246,0.1)] text-accent-blue">read</span>
              </div>
              <p className="text-[13px] text-text-secondary">
                키워드 쿼리(예: <code className="text-accent-orange">&quot;github issue&quot;</code>)로 지연 로딩 도구를 검색합니다.
            ...
            <div className="bg-bg-card border border-border rounded-xl p-5 mb-3">
              <div className="flex items-center gap-2 mb-2">
                <code className="text-[13px] font-bold text-accent-cyan">size</code>
                <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-[rgba(59,130,246,0.1)] text-accent-blue">getter</span>
              </div>
              <p className="text-[13px] text-text-secondary">
                등록된 도구의 총 개수를 반환합니다. <code className="text-accent-cyan">this.tools.size</code>를 위임합니다.
              </p>
            </div>

            <Callout type="warn" icon="⚠️">
              <strong>중복 등록 금지:</strong> 같은 이름으로 <code className="text-accent-cyan">register()</code>를 두 번 호출하면
              <code className="text-accent-red"> ToolError</code>가 발생합니다. MCP 도구를 재등록하려면 먼저 MCP 서버를 재연결해야 합니다.
            </Callout>
          </section>
        </RevealOnScroll>
...
{vr("registry")}.{fn("registerAll")}([{vr("fileReadTool")}, {vr("fileWriteTool")}, {vr("bashExecTool")}]);
            ...
            <p className="text-[13px] text-text-secondary mb-3">
              상황에 따라 <code className="text-accent-cyan">get()</code>과 <code className="text-accent-cyan">require()</code>를 구분하여 사용합니다.
            </p>
            <CodeBlock>
...
{pc("}")}
            ...
            <p className="text-[13px] text-text-secondary mb-3">
              Agent Loop는 Deferred 모드가 활성화되면 <code className="text-accent-cyan">getHotDefinitionsForLLM()</code>을 호출합니다.
            ...
            <div className="bg-bg-card border border-border rounded-xl p-5 mb-4">
              <div className="text-[13px] text-text-secondary space-y-2">
                <div className="flex items-start gap-2">
                  ...
                  <span><code className="text-accent-cyan">hotTools</code> Set에 포함된 도구 (6개 핵심 도구)</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-accent-green font-bold shrink-0">2.</span>
                  <span>이름이 <code className="text-accent-orange">&quot;mcp__&quot;</code>로 시작하지 않는 모든 내장 도구</span>
                </div>
              </div>
            </div>
            <p className="text-[13px] text-text-secondary mb-3">
            ...
            <DeepDive title="Deferred MCP Loading 상세 흐름">
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <div className="flex items-start gap-2">
                    <span className="text-accent-cyan font-bold shrink-0">Step 1.</span>
                    <span>
                      MCP 서버 연결 시 <code className="text-accent-cyan">setToolSearch(mcpToolSearch)</code>로
                      검색 인스턴스를 연결합니다. 이 시점에서 MCP 도구는 레지스트리에 등록되지만,
                      LLM에는 이름과 설명만 전달됩니다.
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-accent-cyan font-bold shrink-0">Step 2.</span>
                    <span>
                      LLM이 시스템 프롬프트에서 MCP 도구 요약을 보고 특정 도구를 사용하겠다고 결정하면,
                      <code className="text-accent-cyan"> ToolSearch</code> 내장 도구를 호출하여
                      <code className="text-accent-cyan"> searchDeferredTools()</code> 또는
                      <code className="text-accent-cyan"> resolveDeferredTool()</code>로
                      전체 스키마를 가져옵니다.
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-accent-cyan font-bold shrink-0">Step 3.</span>
                    <span>
                ...
                <Callout type="tip" icon="💡">
                  네임스페이스 형식: <code className="text-accent-orange">mcp__서버명__도구명</code> (예: <code className="text-accent-orange">mcp__github__create_issue</code>).
        ...
        <RevealOnScroll>
          <section className="mb-16">
            ...
            <p className="text-[14px] text-text-secondary mb-4">
              ...
              모든 필드는 <code className="text-accent-purple">readonly</code>이거나 명시적 setter를 통해서만 변경 가능합니다.
            </p>
...
{pc("}")}
            ...
            <p className="text-[14px] text-text-secondary mb-4">
              <code className="text-accent-cyan">getHotDefinitionsForLLM()</code>의 필터 조건은 두 가지입니다.
...
{pc("}")}
            ...
            <Callout type="tip" icon="🔍">
              <strong>Zod → JSON Schema 변환:</strong> <code className="text-accent-cyan">zodSchemaToJsonSchema()</code>는
              <code className="text-accent-cyan"> tools/validation.ts</code>에 정의되어 있습니다.
              Zod의 <code className="text-accent-cyan">.describe()</code> 메서드로 추가한 필드 설명이
              JSON Schema의 <code className="text-accent-cyan">description</code> 프로퍼티로 변환됩니다.
            </Callout>
          ...
          <section className="mb-16">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-bg-card border border-border rounded-xl p-5">
                <h4 className="text-[14px] font-bold text-accent-orange mb-2">
                  Q1. &quot;Tool already registered&quot; 에러가 발생합니다
                </h4>
                <p className="text-[13px] text-text-secondary leading-relaxed">
                  <strong>원인:</strong> 같은 이름의 도구를 <code className="text-accent-cyan">register()</code>로 두 번 등록하려고 했습니다.
                  MCP 서버 재연결 시 이전 도구가 아직 등록된 상태일 수 있습니다.
                </p>
                <p className="text-[13px] text-text-secondary leading-relaxed mt-2">
                  <strong>해결:</strong> <code className="text-accent-cyan">has(name)</code>으로 먼저 확인하거나,
                  MCP 서버 매니저의 재연결 로직에서 기존 도구를 정리한 후 다시 등록하세요.
                  ToolRegistry 자체는 <code className="text-accent-red">delete()</code> 메서드를 제공하지 않으므로,
              ...
              <div className="bg-bg-card border border-border rounded-xl p-5">
                ...
                <p className="text-[13px] text-text-secondary leading-relaxed">
                  <strong>원인:</strong> Deferred 모드가 활성화된 상태에서 <code className="text-accent-cyan">getHotDefinitionsForLLM()</code>이
                  호출되면 <code className="text-accent-cyan">mcp__</code> 접두사 도구는 전체 스키마에서 필터링됩니다.
                </p>
                <p className="text-[13px] text-text-secondary leading-relaxed mt-2">
                  <strong>해결:</strong> 이것은 의도된 동작입니다. MCP 도구는 시스템 프롬프트의 요약을 통해 LLM에게 알려지며,
                  LLM이 <code className="text-accent-cyan">ToolSearch</code> 도구를 호출하면
                  <code className="text-accent-cyan"> resolveDeferredTool()</code>이나
                  <code className="text-accent-cyan"> searchDeferredTools()</code>로 전체 스키마가 제공됩니다.
                </p>
              </div>
              ...
              <div className="bg-bg-card border border-border rounded-xl p-5">
                ...
                <p className="text-[13px] text-text-secondary leading-relaxed">
                  <strong>원인:</strong> <code className="text-accent-cyan">hotTools</code> Set은
                  클래스 내부에 하드코딩된 6개 도구명만 포함합니다.
                  새로 만든 내장 도구는 Hot Tool이 아니더라도 <code className="text-accent-cyan">getHotDefinitionsForLLM()</code>에
                  포함됩니다(MCP 도구가 아니므로).
                </p>
                <p className="text-[13px] text-text-secondary leading-relaxed mt-2">
                  <strong>해결:</strong> 내장 도구(non-MCP)라면 별도 설정 없이 자동으로 LLM에 전달됩니다.
                  Hot Tool Set에 추가하고 싶다면 <code className="text-accent-cyan">registry.ts</code>의
                  <code className="text-accent-cyan"> hotTools</code> 초기값에 도구명을 추가하세요.
