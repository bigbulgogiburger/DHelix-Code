...
export default function SlashCommandMenuPage() {
        ...
        <RevealOnScroll>
          <div style={{ marginBottom: "48px" }}>
            ...
            <h1 className="text-3xl font-bold tracking-tight leading-[1.15] mt-4 mb-4">
              <span className="text-gray-900">SlashCommandMenu</span>
            </h1>
        ...
        <RevealOnScroll>
          <section style={{ marginBottom: "64px" }}>
            ...
            <div className="text-[14px] text-gray-600 leading-[1.85] mb-8 space-y-3">
              <p>
                <code className="text-cyan-600">SlashCommandMenu</code>는 사용자가 입력창에
                &quot;/&quot;를 타이핑하면 나타나는 자동완성 팝업 메뉴입니다. 등록된 슬래시 명령어
                목록에서 입력된 접두사와 일치하는 명령어를 필터링하여 보여주고, 키보드로 탐색하여
                선택할 수 있습니다.
              </p>
              <p>
                최대 6개의 항목이 화면에 동시에 표시되며, 더 많은 항목이 있으면 위아래로
                스크롤됩니다. 현재 선택된 항목은 시안색으로 강조되고, 각 항목에는 명령어 이름과
                설명이 함께 표시됩니다.
              </p>
              <p>
                별도의 <code className="text-cyan-600">getMatchingCommands</code> 유틸리티 함수가
                export되어 입력 텍스트에서 슬래시 접두사를 추출하고 매칭되는 명령어를 필터링합니다.
        ...
        <RevealOnScroll>
          <section style={{ marginBottom: "64px" }}>
            ...
            <p className="text-[13px] text-gray-600 mb-3 leading-relaxed">
              SlashCommandMenu 컴포넌트에 전달되는 Props입니다. 모든 프로퍼티는{" "}
              ...
              params={[
                {
                  ...
                  required: true,
                  desc: "모든 사용 가능한 슬래시 명령어 배열 (registry에서 가져옴)",
                },
                {
                  name: "prefix",
                  type: "string",
                  required: true,
                  desc: "'/' 이후의 텍스트로 명령어를 필터링하는 접두사",
                },
                {
                  name: "onSelect",
                  type: "(name: string) => void",
                  required: true,
                  desc: "Tab 또는 Enter로 명령어 선택 시 호출되는 콜백 (명령어 이름 전달)",
                },
                {
                  name: "onClose",
                  type: "() => void",
                  required: true,
                  desc: "Escape로 메뉴 닫기 시 호출되는 콜백",
                },
                {
                  name: "visible",
                  type: "boolean",
                  required: true,
                  desc: "메뉴 표시 여부 (false이면 렌더링하지 않음)",
                },
              ]}
            />
            ...
            <p className="text-[13px] text-gray-600 mb-3 leading-relaxed">
              사용자 입력을 기반으로 슬래시 명령어를 필터링하는 유틸리티 함수입니다. 컴포넌트
              외부에서도 사용할 수 있도록 export됩니다.
            </p>
            <CodeBlock>
              <span className="kw">export function</span>{" "}
              <span className="fn">getMatchingCommands</span>({"\n"}
              {"  "}
              <span className="prop">input</span>: <span className="type">string</span>,{"\n"}
              {"  "}
              <span className="prop">allCommands</span>: <span className="kw">readonly</span>{" "}
              ...
              params={[
                {
                  ...
                  type: "string",
                  required: true,
                  desc: '사용자의 전체 입력 텍스트 (예: "/mo", "/model")',
                },
                {
                  name: "allCommands",
                  type: "readonly SlashCommand[]",
                  required: true,
                  desc: "모든 사용 가능한 슬래시 명령어 배열",
                },
              ]}
            />
            <div className="text-[13px] text-gray-600 mt-3 space-y-1">
              <p>
                &bull; <code className="text-cyan-600">&quot;/&quot;</code>로 시작하지 않으면 빈
                배열 반환
              </p>
              <p>&bull; 공백이 포함되어 있으면(인수 입력 중) 빈 배열 반환</p>
              <p>
                &bull; 대소문자 구분 없이 접두사 매칭 (
                <code className="text-cyan-600">toLowerCase()</code>)
              </p>
            </div>
            ...
            <CodeBlock>
              <span className="kw">const</span> <span className="prop">MAX_VISIBLE</span> ={" "}
            ...
            <ul className="text-[13px] text-gray-600 space-y-2 list-disc list-inside">
              ...
              <li>
                ...
                <code className="text-cyan-600">scrollOffset</code>이 자동으로 0으로 리셋됩니다.
              </li>
              <li>
                <code className="text-cyan-600">useInput</code> 훅은{" "}
                <code className="text-cyan-600">visible</code>이 true이고 필터링 결과가 있을 때만
                활성화됩니다 (<code className="text-cyan-600">isActive</code>).
              </li>
              <li>
                이 컴포넌트는 <code className="text-cyan-600">React.memo</code>로 감싸져 있지{" "}
                <strong>않습니다</strong>. 입력이 바뀔 때마다 prefix가 변경되어 자연스럽게
                리렌더링됩니다.
              </li>
            </ul>
          </section>
        ...
        <RevealOnScroll>
          <section style={{ marginBottom: "64px" }}>
            ...
            <h3 className="text-lg font-bold" style={{ marginTop: "32px", marginBottom: "16px" }}>
              기본 사용법 &mdash; 자동완성 메뉴 표시
            </h3>
            <p className="text-[13px] text-gray-600 mb-4 leading-relaxed">
              사용자 입력 컴포넌트와 함께 사용하는 기본 패턴입니다. 입력이 &quot;/&quot;로 시작하면
              메뉴를 표시합니다.
            </p>
            <CodeBlock>
              <span className="kw">const</span> [<span className="prop">input</span>,{" "}
              <span className="prop">setInput</span>] = <span className="fn">useState</span>(
              <span className="str">&quot;&quot;</span>);
              {"\n"}
              <span className="kw">const</span> <span className="prop">showMenu</span> ={" "}
              <span className="prop">input</span>.<span className="fn">startsWith</span>(
              <span className="str">&quot;/&quot;</span>);
              {"\n"}
              {"\n"}
              <span className="kw">{"<"}</span>
              <span className="fn">SlashCommandMenu</span>
              {"\n"}
              {"  "}
              <span className="prop">commands</span>={"{"}
              {"{"}
              <span className="prop">allCommands</span>
              {"}"}
              {"}"}
              {"\n"}
              {"  "}
              ...
              {"\n"}
              {"  "}
              <span className="prop">visible</span>={"{"}
              {"{"}
              <span className="prop">showMenu</span>
              {"}"}
              {"}"}
              {"\n"}
              {"  "}
              ...
              {"{"}
              <span className="fn">handleSelect</span>
              {"}"}
              {"}"}
              {"\n"}
              {"  "}
            ...
            <CodeBlock>
              ...
              {"\n"}
              <span className="kw">function</span> <span className="fn">handleSelect</span>(
              <span className="prop">name</span>: <span className="type">string</span>) {"{"}
              {"\n"}
              {"  "}
              <span className="fn">setInput</span>(<span className="str">`/${"{"}</span>
            ...
            <Callout type="warn" icon="!">
              ...
              <code>getMatchingCommands</code> 내부에서 &quot;/&quot; 접두사 추출과 필터링을
              자동으로 처리합니다. &quot;/&quot;를 제거한 텍스트를 전달하면 필터링이 작동하지
              않습니다.
            </Callout>
            ...
            <Callout type="tip" icon="*">
              <strong>팁:</strong> 위아래 방향키는 순환하지 않습니다 (PermissionPrompt의 좌우
              화살표와 다름). 첫 번째 항목에서 위쪽을 누르거나 마지막 항목에서 아래쪽을 누르면 아무
              일도 일어나지 않습니다.
              <code className="text-cyan-600">Math.max(0, ...)</code>와{" "}
              <code className="text-cyan-600">Math.min(length - 1, ...)</code>로 범위를 제한합니다.
            </Callout>
            ...
            <DeepDive title="getMatchingCommands 필터링 로직 상세">
              ...
              <CodeBlock>
                <span className="kw">export function</span>{" "}
                <span className="fn">getMatchingCommands</span>(<span className="prop">input</span>,{" "}
                <span className="prop">allCommands</span>) {"{"}
                {"\n"}
                {"  "}
                ...
                {"\n"}
                {"  "}
                <span className="kw">const</span> <span className="prop">prefix</span> ={" "}
                <span className="prop">trimmed</span>.<span className="fn">slice</span>(
                <span className="num">1</span>).<span className="fn">toLowerCase</span>();
                {"\n"}
                {"\n"}
                {"  "}
                ...
                {"\n"}
                {"  "}
                <span className="kw">if</span> (<span className="prop">prefix</span>.
                ...
                {"\n"}
                {"  "}
                <span className="kw">return</span> <span className="prop">allCommands</span>.
                <span className="fn">filter</span>({"\n"}
                {"    "}(<span className="prop">cmd</span>) =&gt; <span className="prop">cmd</span>.
              ...
              <p className="mt-3 text-gray-600">
                예시: <code>&quot;/mo&quot;</code> 입력 시 &rarr; prefix는{" "}
                <code>&quot;mo&quot;</code> &rarr;
                <code>/model</code>, <code>/mode</code>, <code>/mock</code> 등이 매칭됩니다.
                <code>&quot;/model gpt-4&quot;</code> 입력 시 &rarr; 공백이 포함되어 빈 배열이
                반환되고 메뉴가 닫힙니다.
              </p>
            </DeepDive>
          </section>
        ...
        <RevealOnScroll>
          <section style={{ marginBottom: "64px" }}>
            ...
            <p className="text-[13px] text-gray-600 mb-4 leading-relaxed">
              ...
              <code className="text-cyan-600">selectedIndex</code>와{" "}
              <code className="text-cyan-600">scrollOffset</code>으로 스크롤 윈도우를 관리합니다.
            </p>
  ...
  style INDICATOR_DOWN fill:#f1f5f9,stroke:#64748b,color:#1e293b`}
            ...
            <CodeBlock>
              ...
              <span className="kw">const</span> <span className="prop">next</span> ={" "}
              <span className="fn">Math</span>.<span className="fn">min</span>(
              <span className="prop">filtered</span>.<span className="prop">length</span> -{" "}
              ...
              <span className="fn">Math</span>.<span className="fn">max</span>(
              <span className="prop">so</span>, <span className="prop">next</span> -{" "}
              <span className="prop">MAX_VISIBLE</span> + <span className="num">1</span>){"\n"}
              {"      "});
              {"\n"}
              {"      "}
              <span className="kw">return</span> <span className="prop">next</span>;{"\n"}
              ...
              {"  "}
              <span className="kw">else if</span> (<span className="prop">key</span>.
              <span className="prop">tab</span> || <span className="prop">key</span>.
              ...
              {"\n"}
              {"    "}
              <span className="kw">if</span> (<span className="prop">filtered</span>.
              <span className="prop">length</span> {">"} <span className="num">0</span>) {"{"}
              {"\n"}
              {"      "}
              <span className="fn">onSelect</span>(<span className="prop">filtered</span>[
              <span className="prop">selectedIndex</span>]!.<span className="prop">name</span>);
              {"\n"}
              {"    "}
              {"}"}
              {"\n"}
              ...
              {"  "}
              <span className="kw">else if</span> (<span className="prop">key</span>.
              <span className="prop">escape</span>) {"{"}
              {"\n"}
              {"    "}
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5 mt-4 text-[13px] text-gray-600 space-y-2.5">
              <p>
                ...
                <code className="text-cyan-600">Math.max(0, prev - 1)</code>로 인덱스가 음수가 되지
                않도록 합니다.
              </p>
              <p>
                <strong className="text-gray-900">[2]</strong>{" "}
                <code className="text-cyan-600">Math.min(so, next)</code>로 스크롤 오프셋이 선택
                위치보다 아래에 있지 않도록 조정합니다. 선택이 현재 윈도우 위로 벗어나면 윈도우가
                따라 올라갑니다.
              </p>
              <p>
                <strong className="text-gray-900">[3]</strong>{" "}
                <code className="text-cyan-600">Math.min(filtered.length - 1, prev + 1)</code>로
                인덱스가 배열 범위를 넘지 않도록 합니다.
              </p>
              <p>
                <strong className="text-gray-900">[4]</strong>{" "}
                <code className="text-cyan-600">Math.max(so, next - MAX_VISIBLE + 1)</code>로 선택이
                현재 윈도우 아래로 벗어나면 윈도우가 따라 내려갑니다.
              </p>
              <p>
                <strong className="text-gray-900">[5]</strong> Tab과 Enter 모두 같은 동작(선택)을
                합니다. 필터링 결과가 비어있으면 아무 일도 하지 않습니다.
              </p>
              <p>
                <strong className="text-gray-900">[6]</strong> Escape를 누르면{" "}
                <code className="text-cyan-600">onClose</code> 콜백을 호출하여 메뉴를 닫습니다.
              </p>
            </div>
          </section>
        </RevealOnScroll>
        ...
        <RevealOnScroll>
          <section style={{ marginBottom: "64px" }}>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5 mb-4">
              ...
              <ul className="text-[13px] text-gray-600 space-y-2 list-disc list-inside">
                <li>
                  <strong>visible Props:</strong> 부모 컴포넌트에서{" "}
                  <code className="text-cyan-600">visible</code>을 true로 설정하고 있는지
                  확인하세요.
                </li>
                <li>
                  <strong>commands 배열:</strong> 빈 배열을 전달하면 필터링 결과도 비어있어 메뉴가
                  표시되지 않습니다. 명령어 레지스트리가 올바르게 초기화되었는지 확인하세요.
                </li>
                <li>
                  <strong>공백 포함:</strong> &quot;/ &quot;(슬래시 + 공백)을 입력하면{" "}
                  <code className="text-cyan-600">getMatchingCommands</code>가 빈 배열을 반환합니다.
                  공백 없이 &quot;/&quot;만 입력해야 합니다.
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5 mb-4">
              ...
              <p className="text-[13px] text-gray-600 leading-relaxed">
                ...
                실제 명령어 실행은 부모 컴포넌트에서 처리해야 합니다. 콜백에서 입력 텍스트를
                완성하고(<code>&quot;/name &quot;</code>), 명령어 실행기로 전달하는 로직이 올바르게
                구현되어 있는지 확인하세요.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5">
              ...
              <p className="text-[13px] text-gray-600 leading-relaxed mb-3">
                SlashCommandMenu는 <code className="text-cyan-600">commands</code> Props로 전달받은
                명령어만 표시합니다. 새 명령어가{" "}
                <code className="text-cyan-600">Command Registry</code>에 올바르게 등록되었는지,
