...
export default function ToolNotebookEditPage() {
        ...
        <RevealOnScroll>
          <div style={{ marginBottom: "48px" }}>
            ...
            <h1 className="text-3xl font-bold tracking-tight leading-[1.15] mt-4 mb-4">
              <span className="text-gray-900">notebook_edit</span>
            </h1>
          ...
          <section style={{ marginBottom: "64px" }}>
            ...
            <div className="text-[14px] text-gray-600 leading-[1.85] mb-8 space-y-3">
              <p>
                ...
                프로그래밍 방식으로 편집하는 도구입니다. .ipynb 파일은 JSON 형식으로 저장되며, 코드
                셀과 마크다운 셀로 구성됩니다.
              </p>
              <p>
                세 가지 작업을 지원합니다: <code className="text-cyan-600">&quot;add&quot;</code>(새
                셀 삽입),
                <code className="text-cyan-600">&quot;replace&quot;</code>(기존 셀 교체),
                <code className="text-cyan-600">&quot;delete&quot;</code>(셀 삭제). 편집 후 노트북을
                JSON으로 직렬화하여 파일에 다시 저장합니다.
              </p>
              <p>
                권한 수준은 <code className="text-amber-600">&quot;confirm&quot;</code>입니다.
                파일을 직접 변경하므로 사용자 확인이 필요합니다. 30초 타임아웃이 설정되어 있으며,
                경로 해석에 <code className="text-cyan-600">resolvePath()</code>를 사용합니다.
              </p>
            </div>
  ...
  style IPYNB fill:#dcfce7,stroke:#10b981,color:#065f46`}
            ...
            <Callout type="info" icon="💡">
              ...
              노트북의 각 &quot;셀&quot;이 스프레드시트의 &quot;행&quot;에 해당하고, 셀 인덱스가 행
              번호에 해당합니다. 0-based 인덱스를 사용합니다.
            </Callout>
          </section>
        </RevealOnScroll>
        ...
        <RevealOnScroll>
          <section style={{ marginBottom: "64px" }}>
            ...
            <p className="text-[13px] text-gray-600 mb-3 leading-relaxed">
              노트북 경로, 작업 종류, 셀 인덱스, 셀 타입, 소스 내용을 정의하는 입력 매개변수
              스키마입니다.
            </p>
            <ParamTable
              params={[
                {
                  ...
                  type: "string",
                  required: true,
                  desc: "편집할 .ipynb 노트북 파일 경로",
                },
                {
                  name: "action",
                  type: '"add" | "replace" | "delete"',
                  required: true,
                  desc: "수행할 작업: add(추가), replace(교체), delete(삭제)",
                },
                {
                  name: "cellIndex",
                  type: "number (0-based)",
                  required: false,
                  desc: "셀 인덱스. add: 삽입 위치(미지정 시 맨 끝), replace/delete: 대상 셀(필수)",
                },
                {
                  name: "cellType",
                  type: '"code" | "markdown"',
              ...
              params={[
                {
                  ...
                  type: "string",
                  required: true,
                  desc: '셀 타입: "code", "markdown", "raw"',
                },
                {
                  name: "source",
                  type: "string[]",
                  required: true,
                  desc: "줄별 문자열 배열 (마지막 줄 제외 모든 줄에 \\n 포함)",
                },
                {
                  name: "metadata",
                ...
                },
                {
                  ...
                  type: "unknown[]",
                  required: false,
                  desc: "코드 셀의 출력 (코드 셀에만 존재)",
                },
                {
                  name: "execution_count",
                  type: "number | null",
                  required: false,
                  desc: "실행 카운트 (미실행 시 null, 코드 셀에만 존재)",
                },
              ]}
            />
            ...
            <ParamTable
              params={[
                { name: "cells", type: "NotebookCell[]", required: true, desc: "모든 셀의 배열" },
                {
                  ...
                  type: "Record<string, unknown>",
                  required: true,
                  desc: "노트북 메타데이터 (커널, 언어 정보 등)",
                },
                {
                  name: "nbformat",
                  type: "number",
                  required: true,
                  desc: "Notebook 형식 메이저 버전 (보통 4)",
                },
                {
                  name: "nbformat_minor",
                  type: "number",
                  required: true,
                  desc: "Notebook 형식 마이너 버전",
                },
              ]}
            />
            ...
            <p className="text-[13px] text-gray-600 mb-3">
              Jupyter 형식에 맞는 새 셀 객체를 생성합니다. 소스 텍스트를 줄별 배열로 변환하고, 코드
              셀인 경우 빈 outputs와 null execution_count를 추가합니다.
            </p>
            <CodeBlock>
            ...
            <ul className="text-[13px] text-gray-600 space-y-2 list-disc list-inside">
              ...
              <li>
                ...
                <code className="text-cyan-600">replace</code>와{" "}
                <code className="text-cyan-600">delete</code> 작업에서는 필수이고,
                <code className="text-cyan-600">add</code>에서는 미지정 시 맨 끝에 추가됩니다.
              </li>
              <li>
                <code className="text-cyan-600">source</code>는{" "}
                <code className="text-cyan-600">add</code>와
                <code className="text-cyan-600">replace</code> 작업에서 필수입니다.
                <code className="text-cyan-600">delete</code>에서는 무시됩니다.
              </li>
              <li>
                저장 시 <code className="text-cyan-600">JSON.stringify(notebook, null, 1)</code>로
                indent 1을 사용합니다. 원본 파일의 들여쓰기와 다를 수 있습니다.
              </li>
              <li>
        ...
        <RevealOnScroll>
          <section style={{ marginBottom: "64px" }}>
            ...
            <CodeBlock>
              ...
              <span className="str">&quot;analysis.ipynb&quot;</span>,{"\n"}
              {"  "}
            ...
            <CodeBlock>
              ...
              {"  "}
              <span className="prop">cellType</span>:{" "}
              <span className="str">&quot;markdown&quot;</span>,{"\n"}
              {"  "}
              <span className="prop">source</span>:{" "}
              <span className="str">
                &quot;## Data Analysis\n\nThis section analyzes the dataset.&quot;
              </span>
              {"\n"}
              {"}"}
            </CodeBlock>
            ...
            <Callout type="warn" icon="!">
              ...
              <code>cellIndex</code>는 0부터 시작하며, 유효 범위는 <code>[0, totalCells-1]</code>
              입니다.
            </Callout>
            ...
            <DeepDive title="Jupyter source 배열 형식 상세">
              <p className="mb-3">
                Jupyter Notebook은 셀의 소스를 줄별 문자열 배열로 저장합니다. 마지막 줄을 제외한
                모든 줄에 <code className="text-cyan-600">\n</code>이 붙습니다:
              </p>
              <CodeBlock>
                ...
                <span className="str">&quot;df = pd.read_csv(&apos;data.csv&apos;)&quot;</span>]
              </CodeBlock>
              <p className="mt-3 text-gray-600">
                <code className="text-cyan-600">createCell()</code> 함수가 이 변환을 자동으로
                처리합니다. 코드 셀인 경우 빈 <code className="text-cyan-600">outputs: []</code>와
        ...
        <RevealOnScroll>
          <section style={{ marginBottom: "64px" }}>
            ...
            <p className="text-[13px] text-gray-600 mb-4 leading-relaxed">
              <code className="text-cyan-600">execute()</code> 함수의 전체 실행 흐름입니다. 파일
              읽기, 유효성 확인, 작업 수행, 파일 저장 순서로 처리됩니다.
            </p>
  ...
  style RESULT fill:#dcfce7,stroke:#10b981,color:#065f46`}
            ...
            <p className="text-[13px] text-gray-600 mb-4 leading-relaxed">
              <code className="text-cyan-600">createCell()</code> 함수의 소스 텍스트 변환
              로직입니다.
            </p>
            <CodeBlock>
              <span className="kw">function</span> <span className="fn">createCell</span>(
              ...
              {"\n"}
              {"  "}
              <span className="kw">const</span> <span className="prop">sourceLines</span> ={" "}
              <span className="prop">source</span>
              {"\n"}
              {"    "}.<span className="fn">split</span>(
              <span className="str">&quot;\\n&quot;</span>){"\n"}
              {"    "}.<span className="fn">map</span>((<span className="prop">line</span>,{" "}
              <span className="prop">i</span>, <span className="prop">arr</span>) =&gt;
              {"\n"}
              {"      "}
              ...
              {"\n"}
              {"  "}
              <span className="kw">const</span> <span className="prop">cell</span>:{" "}
              <span className="type">NotebookCell</span> = {"{"}
              {"\n"}
              {"    "}
              ...
              {"\n"}
              {"  "}
              <span className="kw">if</span> (<span className="prop">cellType</span> ==={" "}
              <span className="str">&quot;code&quot;</span>) {"{"}
              {"\n"}
              {"    "}
              <span className="prop">cell</span>.<span className="prop">outputs</span> = [];
              {"\n"}
              {"    "}
              <span className="prop">cell</span>.<span className="prop">execution_count</span> ={" "}
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5 mt-4 text-[13px] text-gray-600 space-y-2.5">
              <p>
                <strong className="text-gray-900">[1]</strong> 소스 텍스트를{" "}
                <code className="text-cyan-600">\n</code>으로 분할하여 줄별 배열로 변환합니다.
              </p>
              <p>
                <strong className="text-gray-900">[2]</strong> Jupyter 형식 규칙에 따라 마지막 줄을
                제외한 모든 줄에 <code className="text-cyan-600">\n</code>을 붙입니다. 이는
                Jupyter가 셀을 렌더링할 때 줄바꿈을 올바르게 처리하기 위함입니다.
              </p>
              <p>
                <strong className="text-gray-900">[3]</strong> 코드 셀에는 실행 결과를 저장하는{" "}
                <code className="text-cyan-600">outputs</code> 배열과 실행 횟수를 나타내는{" "}
                <code className="text-cyan-600">execution_count</code>가 필요합니다. 새로 생성된
                셀은 아직 실행하지 않았으므로 null입니다.
              </p>
            </div>
          </section>
        </RevealOnScroll>
          ...
          <section style={{ marginBottom: "64px" }}>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5 mb-4">
              ...
              <p className="text-[13px] text-gray-600 leading-relaxed">
                .ipynb 파일이 유효한 Jupyter Notebook 형식이 아닙니다. 파일이 올바른 JSON이고{" "}
                <code className="text-cyan-600">cells</code> 배열이 최상위에 존재하는지 확인하세요.
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5 mb-4">
              ...
              <ul className="text-[13px] text-gray-600 space-y-2 list-disc list-inside">
                <li>
                  <strong>add:</strong> 유효 범위는{" "}
                  <code className="text-cyan-600">[0, totalCells]</code> (맨 끝 포함)
                </li>
                <li>
                  <strong>replace/delete:</strong> 유효 범위는{" "}
                  <code className="text-cyan-600">[0, totalCells-1]</code>
                </li>
              </ul>
              <Callout type="tip" icon="*">
                노트북의 현재 셀 수를 확인하려면 먼저 <code>read_file</code> 도구로 .ipynb 파일을
                읽어 셀 수를 확인하세요.
              </Callout>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5 mb-4">
              ...
              <p className="text-[13px] text-gray-600 leading-relaxed">
                .ipynb 파일의 JSON이 올바르지 않습니다. 파일이 손상되었거나, 다른 프로그램에 의해
                잘못된 형식으로 저장되었을 수 있습니다. JSON 유효성 검사 도구로 파일을 확인하세요.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5">
              ...
              <p className="text-[13px] text-gray-600 leading-relaxed">
                ...
                indent 1을 사용합니다. 원본 파일이 다른 들여쓰기(예: 2 또는 4)를 사용했다면 저장 후
                들여쓰기가 변경됩니다. 기능에는 영향이 없지만 git diff에 노이즈가 발생할 수
                있습니다.
              </p>
            </div>
          </section>
