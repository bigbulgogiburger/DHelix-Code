...
export default function InstructionPathMatcherPage() {
        ...
        <div style={{ marginBottom: "48px" }}>
          ...
          <h1 className="text-3xl font-bold tracking-tight leading-[1.15] mb-3">
            <span className="text-gray-900">
              Instruction Path Matcher
            </span>
          </h1>
          <p className="text-[16px] text-gray-600 max-w-[640px]">
            경로 조건부 규칙 매칭 모듈 &mdash; 작업 디렉토리/파일 경로에 따라
            적용할 규칙을 결정합니다. <span className="text-cyan-600 font-semibold">glob 패턴</span>을
            <span className="text-violet-600 font-semibold"> 정규식</span>으로 변환하여 경로를 매칭합니다.
          </p>
        </div>
        </RevealOnScroll>
        ...
        <RevealOnScroll>
          <section style={{ marginBottom: "64px" }}>
            ...
            <p className="text-[14px] text-gray-600 leading-relaxed mb-4">
              ...
              프론트매터로 <strong className="text-gray-900">경로 패턴</strong>을 지정하면,
              해당 경로에서 작업할 때만 해당 규칙이 시스템 프롬프트에 포함됩니다.
              예를 들어, <code className="text-cyan-600 text-xs">src/components/**</code> 패턴을 지정하면
              React 컴포넌트 작업 시에만 프론트엔드 규칙이 적용됩니다.
            </p>

            <Callout type="tip" icon="💡">
              <strong>핵심 원칙:</strong> 규칙의 patterns 배열은 <strong>OR 조건</strong>입니다.
              하나라도 일치하면 해당 규칙이 적용됩니다. Windows 경로(백슬래시)도 자동으로 정규화합니다.
            </Callout>
  ...
  style COLLECT fill:#f8fafc,stroke:#06b6d4,color:#06b6d4,stroke-width:2px`}
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5 mt-4">
              ...
              <div className="flex flex-col gap-2.5 text-[13px] text-gray-600">
                <div className="flex gap-3">
                  <span className="text-amber-600 font-bold shrink-0 w-16"><code className="text-xs">*</code></span>
                  <span>슬래시(/)를 제외한 모든 문자 &mdash; 한 디렉토리 레벨만 매칭 (예: <code className="text-cyan-600 text-xs">src/*.ts</code>)</span>
                </div>
                <div className="flex gap-3">
                  <span className="text-violet-600 font-bold shrink-0 w-16"><code className="text-xs">**</code></span>
                  <span>슬래시 포함 모든 문자 &mdash; 여러 디렉토리 횡단 (예: <code className="text-cyan-600 text-xs">src/**/*.tsx</code>)</span>
                </div>
                <div className="flex gap-3">
                  <span className="text-blue-600 font-bold shrink-0 w-16"><code className="text-xs">?</code></span>
                  <span>슬래시를 제외한 단일 문자 (예: <code className="text-cyan-600 text-xs">src/?.ts</code> &rarr; <code className="text-cyan-600 text-xs">a.ts</code>)</span>
                </div>
                <div className="flex gap-3">
                  <span className="text-emerald-600 font-bold shrink-0 w-16"><code className="text-xs">.</code></span>
                  <span>리터럴 점 (자동으로 <code className="text-cyan-600 text-xs">\.</code>로 이스케이프)</span>
                </div>
              </div>
            </div>
          </section>
          ...
          <section style={{ marginBottom: "64px" }}>
            ...
            <div className="mb-8">
              ...
              <p className="text-[13px] text-gray-600 mb-3">
                경로 기반 규칙 조건 인터페이스입니다. patterns 배열 중 하나라도 일치하면 이 규칙이 적용됩니다 (OR 조건).
              </p>
            ...
            <div className="mb-8">
              <h3 className="text-lg font-bold mb-2 flex items-center gap-2">
                ...
                <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-emerald-50 text-emerald-600">exported</span>
                <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-blue-50 text-blue-600">interface</span>
                <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-red-50 text-red-600">deprecated</span>
              </h3>
              <p className="text-[13px] text-gray-600 mb-3">
                단일 <code className="text-cyan-600 text-xs">pattern</code> 필드를 사용하는 이전 버전 인터페이스입니다.
                <code className="text-cyan-600 text-xs"> normalizeLegacyRule()</code>로 새 형식으로 변환할 수 있습니다.
              </p>
            ...
            <div className="mb-8">
              ...
              <p className="text-[13px] text-gray-600 mb-3">
                이전 형식(단일 패턴)의 규칙을 새 형식(패턴 배열)으로 변환합니다.
                단일 pattern 값을 patterns 배열에 넣어 PathRule로 반환합니다.
              </p>
              ...
              />
              <div className="mt-3">
                <h4 className="text-[13px] font-bold text-gray-900 mb-2">반환 타입: <code className="text-violet-600 text-xs">PathRule</code></h4>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="text-[13px] text-gray-600 mb-3">
                경로가 단일 glob 패턴과 일치하는지 확인합니다.
                내부적으로 <code className="text-cyan-600 text-xs">globToRegex()</code>로 패턴을 정규식으로 변환합니다.
              </p>
              ...
              />
              <div className="mt-3">
                <h4 className="text-[13px] font-bold text-gray-900 mb-2">반환 타입: <code className="text-violet-600 text-xs">boolean</code></h4>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="text-[13px] text-gray-600 mb-3">
                ...
                <code className="text-cyan-600 text-xs"> Array.some()</code>을 사용하여 첫 매칭에서 즉시 반환합니다.
              </p>
            ...
            <div className="mb-8">
              ...
              />
              <div className="mt-3">
                <h4 className="text-[13px] font-bold text-gray-900 mb-2">반환 타입: <code className="text-violet-600 text-xs">{"readonly PathRule[]"}</code></h4>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="text-[13px] text-gray-600 mb-3">
                매칭된 규칙의 content를 모두 수집하여 하나의 문자열로 합칩니다.
                여러 규칙이 매칭되면 빈 줄(<code className="text-cyan-600 text-xs">\n\n</code>)로 구분합니다.
              </p>
              ...
              <div className="mt-3">
                ...
                <p className="text-[13px] text-gray-600">매칭된 규칙 내용을 합친 문자열 (매칭 없으면 빈 문자열).</p>
              </div>

              <Callout type="warn" icon="⚠️">
                매칭 결과가 없으면 빈 문자열을 반환합니다. 시스템 프롬프트 빌더에서 빈 문자열은 해당 섹션을 생략하는 데 사용됩니다.
              </Callout>
            </div>
            ...
            <div className="mb-4">
              ...
              <p className="text-[13px] text-gray-600 mb-3">
                glob 패턴을 정규식(RegExp)으로 변환합니다. <code className="text-cyan-600 text-xs">^</code>와
                <code className="text-cyan-600 text-xs"> $</code>로 감싸 전체 문자열 매칭하며, 대소문자를 무시합니다(<code className="text-cyan-600 text-xs">i</code> 플래그).
              </p>
              <ParamTable
                params={[
                  {
        ...
        <RevealOnScroll>
          <section style={{ marginBottom: "64px" }}>
            ...
            <h3 className="text-[15px] font-bold" style={{ marginTop: "32px", marginBottom: "16px" }}>규칙 파일 작성 예시</h3>
            <p className="text-[13px] text-gray-600 mb-3">
            ...
            <h3 className="text-[15px] font-bold" style={{ marginTop: "32px", marginBottom: "16px" }}>코드에서 규칙 매칭</h3>
            <p className="text-[13px] text-gray-600 mb-3">
              <code className="text-cyan-600 text-xs">collectMatchingContent()</code>로
              현재 작업 경로에 해당하는 모든 규칙을 한 번에 수집할 수 있습니다.
            </p>
            ...
            <CodeBlock>
              ...
              <span className="text-[#c9d1d9]">);</span>{"\n\n"}
              <span className="text-[#8b949e]">{"// extra === \"React 컴포넌트는 함수형으로...\""}</span>{"\n"}
              <span className="text-[#8b949e]">{"// 매칭되는 규칙이 없으면 빈 문자열"}</span>
            </CodeBlock>

            <DeepDive title="레거시 형식(단일 패턴) 변환">
              <p className="mb-3">
                이전 버전에서는 단일 <code className="text-cyan-600 text-xs">pattern</code> 필드를 사용했습니다.
                <code className="text-cyan-600 text-xs"> normalizeLegacyRule()</code>로 새 형식으로 변환할 수 있습니다.
              </p>
              ...
              <Callout type="warn" icon="⚠️">
                <code className="text-cyan-600 text-xs">LegacyPathRule</code> 인터페이스는 <code className="text-red-600 text-xs">@deprecated</code>입니다.
                새 코드에서는 <code className="text-cyan-600 text-xs">PathRule</code>의 <code className="text-cyan-600 text-xs">patterns</code> 배열을 사용하세요.
              </Callout>
            </DeepDive>
          </section>
        </RevealOnScroll>
        ...
        <RevealOnScroll>
          <section style={{ marginBottom: "64px" }}>
            ...
            <h3 className="text-[15px] font-bold" style={{ marginTop: "32px", marginBottom: "16px" }}>globToRegex 변환 규칙</h3>
            <p className="text-[13px] text-gray-600 mb-3">
              glob 패턴의 각 문자를 정규식 토큰으로 변환합니다.
              백슬래시는 슬래시로 먼저 정규화하여 Windows 경로를 지원합니다.
            </p>
  ...
  style WRAP fill:#f8fafc,stroke:#10b981,color:#10b981,stroke-width:2px`}
            ...
            <h3 className="text-[15px] font-bold" style={{ marginTop: "32px", marginBottom: "16px" }}>변환 예시</h3>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4 mb-3">
              <div className="overflow-x-auto">
                <table className="w-full border-collapse text-[12px]">
                  <thead>
                    <tr>
                      <th className="p-2.5 text-left text-[10px] font-bold uppercase tracking-wider text-gray-400 bg-gray-50 border-b border-gray-200">glob 패턴</th>
                      <th className="p-2.5 text-left text-[10px] font-bold uppercase tracking-wider text-gray-400 bg-gray-50 border-b border-gray-200">변환된 정규식</th>
            ...
            <Callout type="info" icon="📝">
              <strong>대소문자 무시:</strong> 정규식에 <code className="text-cyan-600 text-xs">i</code> 플래그가 설정되어 있어
              <code className="text-cyan-600 text-xs"> src/Button.TSX</code>와 <code className="text-cyan-600 text-xs">src/button.tsx</code> 모두 매칭됩니다.
            ...
            <div className="flex flex-col gap-4">
              <div className="bg-white border border-gray-200 rounded-xl p-5">
                ...
                <div className="text-[13px] text-gray-600 leading-relaxed">
                  <p className="mb-2">
                    <strong className="text-gray-900">원인 1:</strong> glob 패턴이 전체 경로에 매칭되어야 합니다.
                    <code className="text-cyan-600 text-xs"> ^</code>와 <code className="text-cyan-600 text-xs">$</code>로 감싸져 있으므로
                    부분 매칭이 아닌 전체 매칭입니다. <code className="text-cyan-600 text-xs">*.ts</code>는
                    <code className="text-cyan-600 text-xs"> src/index.ts</code>에 매칭되지 않습니다.
                    <code className="text-cyan-600 text-xs"> **/*.ts</code>를 사용하세요.
                  </p>
                  <p>
                    <strong className="text-gray-900">원인 2:</strong> Windows 경로를 사용하는 경우.
                    <code className="text-cyan-600 text-xs"> globToRegex()</code>가 백슬래시를 자동으로 슬래시로 정규화하지만,
                    입력 경로도 동일하게 정규화되는지 확인하세요.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-5">
                <h4 className="text-[14px] font-bold mb-2 flex items-center gap-2">
                  <span className="text-red-600">Q.</span> 여러 규칙이 동시에 적용되는데 하나만 원해요
                </h4>
                <div className="text-[13px] text-gray-600 leading-relaxed">
                  <p>
                    <code className="text-cyan-600 text-xs">filterMatchingRules()</code>는 매칭되는 <strong>모든</strong> 규칙을 반환합니다.
                    우선순위나 배타적 매칭이 필요하다면 패턴을 더 구체적으로 작성하세요.
                    현재는 우선순위 시스템이 없으며, 모든 매칭 규칙이 시스템 프롬프트에 포함됩니다.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-5">
                ...
                <div className="text-[13px] text-gray-600 leading-relaxed">
                  <p>
                    <code className="text-cyan-600 text-xs">**/</code>는 <code className="text-cyan-600 text-xs">.*</code>로 변환되고
                    후행 슬래시는 건너뜁니다. <code className="text-cyan-600 text-xs">src/**/test.ts</code>는
                    <code className="text-cyan-600 text-xs"> src/a/b/test.ts</code>에 매칭됩니다.
                    패턴 끝에 <code className="text-cyan-600 text-xs">**</code>만 쓰면 모든 하위 경로에 매칭됩니다.
                  </p>
                </div>
              </div>
            </div>
