...
export default function Home() {
  return (
    <>
      {/* Hero */}
      <header className="text-center pt-16 pb-12" style={{ paddingTop: "80px", paddingBottom: "64px" }}>
        <div className="center-wide">
          ...
          >
            architecture.html이 &ldquo;무엇이 있는지&rdquo; 보여줬다면, 이
            문서는 &ldquo;어떻게 동작하는지&rdquo;를 TS 코드와 함께
            보여줍니다. 각 모듈의 상태 흐름, 핵심 인터페이스, 구현 방향을
            담았습니다.
          </p>
          <Link href="/docs"
      ...
      <footer className="border-t border-gray-200 py-12 text-center text-gray-500 text-sm" style={{ paddingTop: "48px", paddingBottom: "48px" }}>
        <div className="center-wide">
          <p className="mb-2">
            <strong className="text-gray-900">dbcode</strong> Module Deep
            Dive Documentation
          </p>
          <p>
            Built with Next.js, Tailwind CSS &amp; Mermaid.js
          </p>
        </div>
      </footer>
    </>
