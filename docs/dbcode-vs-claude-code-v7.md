# dhelix vs Claude Code — v7 종합 비교 분석

> **분석일**: 2026-03-11
> **이전 분석**: v6 (2026-03-11, 9.0/10)
> **Claude Code 기준 버전**: v2.1.72 (2026-03-11 기준)
> **dhelix 기준**: main branch (191 소스 파일, 29,114줄 / 143 테스트, 34,764줄)
...
Claude Code의 `.claude/agents/*.md` 패턴을 dhelix에 완전 구현했다.
...
**에이전트 정의 파일 형식** (`.dhelix/agents/researcher.md`):
...
- **2단계 스코프**: `~/.dhelix/agents/` (user, priority 3) → `.dhelix/agents/` (project, priority 2)
...
- **3스코프 메모리 디렉토리**:
  - `user`: `~/.dhelix/agent-memory/{agentName}/MEMORY.md`
  - `project`: `.dhelix/agent-memory/{agentName}/MEMORY.md`
  - `local`: `.dhelix/agent-memory/local/{agentName}/MEMORY.md`
...
- **3단계 스코프**:
  - `local`: `.dhelix/mcp-local.json` (gitignored, 개인 API키 등)
  - `project`: `.dhelix/mcp.json` (팀 공유)
  - `user`: `~/.dhelix/mcp-servers.json` (글로벌 기본)
...
| 기능                        | Claude Code | dhelix v6 | dhelix v7   |
| --------------------------- | ----------- | --------- | ----------- |
| stdio 트랜스포트            | ✅          | ✅        | ✅          |
...
| 기능               | Claude Code              | dhelix v6   | dhelix v7                           |
| ------------------ | ------------------------ | ----------- | ----------------------------------- |
| 에이전트 정의 파일 | ✅ `.claude/agents/*.md` | ❌ 하드코딩 | ✅ `.dhelix/agents/*.md` **신규**   |
...
2. **에이전트 정의 파일이 확장성 플랫폼을 구축**: `.dhelix/agents/*.md` 파일 하나로
...
> dhelix v7은 Agent Teams 8인 병렬 개발로 **MCP 3-transport 아키텍처**(+2.0),
...
- v6 분석 문서: `docs/dhelix-vs-claude-code-v6.md`
- [Claude Code Agent Teams](https://code.claude.com/docs/en/agent-teams)
- [Claude Code Sub-agents](https://code.claude.com/docs/en/sub-agents)
- [Claude Code MCP](https://code.claude.com/docs/en/mcp)
- [Claude Code Memory](https://code.claude.com/docs/en/memory)
- [Claude Code Security](https://code.claude.com/docs/en/security)
- dhelix 소스 코드 분석: 191 소스 파일 (29,114줄), 143 테스트 파일 (34,764줄)
