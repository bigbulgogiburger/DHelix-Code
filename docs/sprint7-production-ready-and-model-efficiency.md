 ...
 * - eval() / Function() 사용
 */
export function scanGeneratedCode(code: string, language: string): readonly SecurityFinding[];
```
...
- [ ] Crash Reporter: 에러 발생 시 ~/.dhelix/crashes/ 기록
