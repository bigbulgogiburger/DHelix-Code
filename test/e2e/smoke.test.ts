...
describe.skipIf(!hasApiKey)("E2E Smoke Test", () => {
  ...
  it(
    "should complete a simple prompt without tool calls",
    async () => {
    ...
    async () => {
      ...
      const result = await runAgentLoop(
        ...
        [
          {
            role: "system",
            content: "You are a helpful assistant with access to file reading tools. Use the file_read tool to read files when asked.",
          },
          {
            role: "user",
