...
export interface ParsedSymbol {
  ...
  readonly kind: "function" | "class" | "interface" | "type" | "variable" | "method" | "enum" | "import";
...
export class TreeSitterEngine {
  ...
  async findDependencies(filePath: string, direction: "imports" | "importedBy"): Promise<readonly ImportInfo[]>;
}
```
